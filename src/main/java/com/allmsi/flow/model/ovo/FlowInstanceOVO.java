...
public class FlowInstanceOVO {
	...
	public FlowInstanceOVO(FlowInstance flowInstancePo) {
		if (flowInstancePo != null) {
			...
			this.cUserId = flowInstancePo.getcUserId();
		}
	}
	...
	public String toString() {
		return "FlowInstanceOVo [id=" + id + ", flowId=" + flowId + ", objectId=" + objectId + ", cTime=" + cTime
				+ ", flowCode=" + flowCode + ", flowName=" + flowName + ", flowType=" + flowType + ", nodeId=" + nodeId
				+ ", nodeName=" + nodeName + ", routeId=" + routeId + ", routeName=" + routeName + ", cUserId="
				+ cUserId + ", user=" + user + "]";
	}
}
